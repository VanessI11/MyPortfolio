...
В ходе проекты было необходимо:
...
На основе проведенного анализа были проверены необходимые гипотезы о разнице в поведении пользователей с подпиской и без:
...
Также удалось выяснить: возроста пользователей в выборке распределены нормально со средним в 25 лет. Все длины уникальны и распределены нормально со средним в 3070 м. Все длины уникальны (кроме выброса с 95ю оборвавшимися поездками) и распределены нормально со средним в 18 минут.м
